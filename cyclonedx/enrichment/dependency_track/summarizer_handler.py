"""
-> Module for the Summarizer Handler
"""
...
def summarizer_handler(event: dict = None, context: dict = None):
    ...
    """
    -> This handler retrieves the findings file and associated
    -> SBOM from the S3 bucket, adds some metadata,
    -> combines them, and then flattens them into a single file
    -> that uses dot notation. EX: field.subfield.item
    -> The newly created flattened file is then placed into
    -> the S3 bucket with the naming scheme of:
