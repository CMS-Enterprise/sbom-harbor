...
OPENSSF_LOAD_BALANCER_ID = "OPENSSF-LB-ID"
OPENSSF_LOAD_BALANCER_LISTENER_ID = "OPENSSF-LB-LISTENER-ID"
OPENSSF_LOAD_BALANCER_TARGET_ID = "OPENSSF-LB-TARGET-ID"

ALLOW_DT_PORT_SG = f"ALLOW_{DT_API_PORT}_SG"
ALLOW_SCORECARD_PORT_SG = f"ALLOW_{OPENSSF_API_PORT}_SG"
