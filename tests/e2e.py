...
def test_get_team():
    ...
    url = 'https://b5jpfzyp5l.execute-api.us-east-1.amazonaws.com/api/v1/team/dawn-patrol'
    ...
    assert list(team_dict.keys()) == ["dawn-patrol"]
...
def test_get_team_with_children():
    ...
    url = 'https://b5jpfzyp5l.execute-api.us-east-1.amazonaws.com/api/v1/team/dawn-patrol?children=true'
...
def test_update_team_with_children():
    ...
    url = f"https://b5jpfzyp5l.execute-api.us-east-1.amazonaws.com/api/v1/team/{team_id}?children=true"
...
def test_delete_team():
    ...
    url = f"https://b5jpfzyp5l.execute-api.us-east-1.amazonaws.com/api/v1/team/{team_id}"
