...
DEPLOYMENT_AWS_REGION = getenv("CDK_DEFAULT_REGION")
AWS_REGION_SHORT = regionCodes.get(DEPLOYMENT_AWS_REGION)
...
# Step Functions
STATE_MACHINE_NAME = environize("EnrichmentCycle", delimiter="_")
STATE_MACHINE_RULE_NAME = environize("EnrichmentCycleRule", delimiter="_")
...
DT_INTERFACE_LN = f"{ENVIRONMENT}DTN"
DT_INTERFACE_ID = f"{ENVIRONMENT}DTI"
