...
async fn main() {
    ...
    let harbor = Router::new()
        ...
        .route("/v1/teams", get(controllers::team::list))
        .route("/v1/team/:id", get(controllers::team::get))
        .route("/v1/team", post(controllers::team::post))
        .route("/v1/team/:id", put(controllers::team::put))
        .route("/v1/team/:id", delete(controllers::team::delete))
